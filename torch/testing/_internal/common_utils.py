...
if TEST_CUDA and 'NUM_PARALLEL_PROCS' in os.environ:
    ...
    # other libraries take up about 1 GB of space per process
    torch.cuda.set_per_process_memory_fraction(round((gb_available - num_procs) / gb_available / num_procs, 2))
